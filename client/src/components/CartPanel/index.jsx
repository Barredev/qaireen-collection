        ...
        py-3 px-4'>
                 ...
                 pb-4'>
                    ...
                    <div className='info w-[75%] pr-5 relative'>
                        <h4 className='text-[14px] font-[500]'>
                            <Link to="/product/5485" className='link transition-all'>FULL LOGAM SERI AWM-500 AWM-500D-1A</Link>
                        </h4>
                        <p className='flex items-center gap-5 mt-2 mb-2'>
                            <span> Qty : <span>2</span></span>
                            <span className='text-primary font-bold'>Price : Rp.350.000</span>
                        </p>

                        <MdOutlineDeleteOutline className='absolute top-[10px] right-[10px]
                        cursor-pointer text-[20px] transition-all link'/>
            ...
            flex items-center justify-between flex-col'>
                    <div className='flex items-center justify-between w-full'>
                        ...
                        <span className='text-primary font-bold'>Rp350.000</span>
                    </div>
                    <div className='flex items-center justify-between w-full'>
                        <span className='text-[14px] font-[600]'>Shipping</span>
                        <span className='text-primary font-bold'>Rp15.000</span>
                    </div>
                </div>
            ...
            flex items-center justify-between flex-col'>
                    <div className='flex items-center justify-between w-full'>
                        <span className='text-[14px] font-[600]'>Total tax</span>
                        <span className='text-primary font-bold'>Rp5.000</span>
                    </div>
